...
export function HistoryPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Rental History</h1>
        <p className="text-gray-400">Search rental history by customer phone number</p>
      </div>
      ...
      <div className="bg-[#1a1a24] rounded-xl border border-gray-800 p-6">
        ...
        <div className="mt-6">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-cyan-500 hover:bg-cyan-400 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg transition-colors"
          >
            {isLoading ? (
              <>
        ...
        <div className="bg-[#1a1a24] rounded-xl border border-gray-800 overflow-hidden">
          <div className="p-6 border-b border-gray-800">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-white">Rental Records</h2>
              {rentals.length > 0 && (
          ...
          {rentals.length > 0 ? (
            <div className="divide-y divide-gray-800">
              {rentals.map((rental) => (
                <div key={rental.id} className="p-6 hover:bg-gray-800/30 transition-colors">
                  <div className="flex items-start justify-between">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-white font-medium">{rental.pod_name}</p>
                          <p className="text-sm text-gray-400">{rental.console_name}</p>
                        </div>
                      </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">No rental history found for this phone number</p>
            </div>
          )}
        </div>
      )}
